---
name: analyze
description: Use when the user asks to analyze trading performance, check PnL, review trade history, get a performance summary, or asks "how are we doing". Queries the live EC2 SQLite database.
